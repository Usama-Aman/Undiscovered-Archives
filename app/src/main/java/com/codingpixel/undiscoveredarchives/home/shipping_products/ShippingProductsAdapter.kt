...
import com.codingpixel.undiscoveredarchives.home.draft_products.DraftProductsAdapter
import com.codingpixel.undiscoveredarchives.home.shipping_products.ShippingProductsActivity.Companion.isSelectEnable
import com.codingpixel.undiscoveredarchives.utils.viewGone
import com.codingpixel.undiscoveredarchives.utils.viewVisible

class ShippingProductsAdapter(var shippingProductsInterface: ShippingProductsInterface) :
    ...
    inner class Item(val binding: ItemProductsBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(position: Int) {
            ...
            binding.root.setOnClickListener {
                if (isSelectEnable) {
                    shippingProductsInterface.showListOptions(position)
                } else {
                    shippingProductsInterface.onItemClicked(position)
                }
            }
        }
