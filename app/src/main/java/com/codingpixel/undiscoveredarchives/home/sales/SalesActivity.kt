...
import com.codingpixel.undiscoveredarchives.home.purchases.CurrentOrdersFragment
import com.codingpixel.undiscoveredarchives.home.purchases.PurchasesFragment
...
class SalesActivity : BaseActivity() {
    ...
    private fun initViews() {
        binding.topBar.tvScreenTitle.text = "Sales"
    ...
    private fun addTabs() {
        val salesViewPager = SalesViewPager(this)
        binding.viewPager.adapter = salesViewPager
    ...
    inner class SalesViewPager(fa: FragmentActivity) : FragmentStateAdapter(fa) {
