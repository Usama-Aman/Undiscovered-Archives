...
class ShipmentPlaced : DialogFragment() {

    private lateinit var binding: DialogShippmentPlacedBinding
    ...
    override fun onCreateView(
        ...
        binding = DialogShippmentPlacedBinding.inflate(layoutInflater, container, false)
